...
{
    // Spawn the correct StoreController here
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
        firstControllerPortrait = [[FirstControllerPortraitIpad alloc] initWithNibName:@"FirstControllerPortraitIpad" bundle:nil];
    } else {
        firstControllerPortrait = [[FirstControllerPortraitIphone alloc] initWithNibName:@"FirstControllerPortraitIphone" bundle:nil];
    }
